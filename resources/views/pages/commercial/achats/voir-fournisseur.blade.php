                    ...
                    <div class="widget-content widget-content-area mb-2 rounded-0">
                        <div class="row">
                            <div class="col-12 col-lg-6 text-lg-left text-center">
                                <h4 class=""><b>{{ $supplier->_name }}</b>  
                                    <div class="btn-group no-hide" role="group">
                                        <button id="btn_show_upload_file" target="{{ $supplier->id }}" class="position-relative dropdown-toggle btn-custom-light bg-gray border rounded pt-1 pb-1 pl-2 pr-2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" type="button"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file"><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path><polyline points="13 2 13 9 20 9"></polyline></svg> <span class="badge badge-info counter" id="counter_files"></span></button> 

                                        <div class="dropdown-menu shadow-lg" aria-labelledby="btn_upload_file" style="width:500px;">
                                            <div id="errorContent"></div>
                                            <div id="fileuploadContent"></div>
                                            <div class="">
                                                <input type="file" name="supplierFile" id="supplierFile" class="input_file_to_hide" data-target="{{ $supplier->id }}" accept=".csv, .xls, .xlsx, .xlsm, .jpg, .jpeg, .txt, .odt, .gif, .png, .pdf, .doc, .docx, .ppt, .pptx, .odf, .ods, .rtf" />
                                                <label for="supplierFile" class="btn btn-block shadow filelab bg-gray text-primary border rounded" id="btn_upload_file"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#ffffff" stroke="#1b55e2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-plus"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="12" y1="18" x2="12" y2="12"></line><line x1="9" y1="15" x2="15" y2="15"></line></svg> Ajouter un fichier</label>
                                            </div>
                                        </div>
                                    </div> 
                                </h4>
                                <span class=""><b>Créé le {{ returnDate(substr($supplier->created_at,0,10)) }} à {{ substr($supplier->created_at,11,5) }}</b></span>
                            </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <table class="table table-bordered table-hover table-sm">
                                                            <tr>
                                                                <td>Téléphone 1</td>
                                                                <td class="text-dark">{{ $supplier->tel1 }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Téléphone 2</td>
                                                                <td class="text-dark">{{ $supplier->tel2 }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Adresse mail</td>
                                                                <td class="text-dark">{{ $supplier->email }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Site web</td>
                                                                <td class="text-dark">{{ $supplier->website }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Adresse</td>
                                                                <td class="text-dark">{{ $supplier->address }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Ville</td>
                                                                <td class="text-dark">{{ $supplier->city }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Pays</td>
                                                                <td class="text-dark">{{ $supplier->country }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Commune</td>
                                                                <td class="text-dark">{{ $supplier->township }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Quartier</td>
                                                                <td class="text-dark">{{ $supplier->_district }}</td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <table class="table table-sm table-hover table-bordered">
                                                            <tr>
                                                                <td>Code</td>
                                                                <td class="text-dark">{{ $supplier->code }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Notes</td>
                                                                <td class="text-dark">{{ $supplier->notes }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Conditions</td>
                                                                <td class="text-dark">{{ $supplier->conditions }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Mode de règlement</td>
                                                                <td class="text-dark">{{ $supplier->payment_mode }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>E-document</td>
                                                                <td>{!! getEdocument($supplier->e_document) !!}</td>
                                                            </tr> 
                                                            <tr>
                                                                <td>N° d'immatriculation</td>
                                                                <td class="text-dark">{{ $supplier->legal_id }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Banque</td>
                                                                <td class="text-dark">{{ $supplier->bank_name }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>N° de compte</td>
                                                                <td class="text-dark">{{ $supplier->bank_account }}</td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                </div>
                            ...
                            <div class="widget-content widget-content-area rounded-0 mb-2">
                                <div class="mb-3 border rounded p-3">
                                    ...
                                    <ul class="nav nav-tabs nav-fill mb-3 mt-3" id="borderTop" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="border-top-sales-tab" data-toggle="tab" href="#border-top-sales" role="tab" aria-controls="border-top-sales" aria-selected="false">Achats</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content" id="borderTopContent">
                                        ...
                                        <div class="tab-pane fade" id="border-top-sales" role="tabpanel" aria-labelledby="border-top-sales-tab">
                                            achats - Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolorem, eius rem sit aut, totam veniam vel explicabo esse quibusdam itaque accusamus eaque natus! Tenetur vero reprehenderit at doloremque veritatis itaque.
                                        </div>
                                    </div>
                                </div>
                                <div class="border p-3 rounded">
                                    <h6><b>Activité</b> <a href="/ventes/getClientCharts/1">link_to_charts</a> </h6>
                                    <ul class="nav nav-tabs nav-fill mb-3 mt-3" id="borderTop" role="tablist">
                                        <li class="nav-item">
