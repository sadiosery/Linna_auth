        ...
        <div class="row layout-top-spacing" id="cancel-row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="statbox widget box box-shadow">
                    <div class="col-12 bg-white pt-2 mb-3">
                        <div class="row">
                            <div class="col-12 col-md-5 text-md-left text-center pt-2">
                                <h5><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevrons-right"><polyline points="13 17 18 12 13 7"></polyline><polyline points="6 17 11 12 6 7"></polyline></svg><b>Liste des devis</b></h5>
                            </div>
                    ...
                    <div class="widget-content widget-content-area text-center pt-5 mb-3">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-xl-3 pb-3">
                                <h6 class="text-uppercase">Acceptés</h6>
                            ...
                            <div class="col-12 col-md-6 col-xl-3 pb-3">
                                <h6 class="text-uppercase">Refusés / Expirés</h6>
