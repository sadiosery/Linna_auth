@if ($page_name != 'coming_soon' && $page_name != 'contact_us' && $page_name != 'error404' && $page_name != 'error500' && $page_name != 'error503' && $page_name != 'faq' && $page_name != 'helpdesk' && $page_name != 'maintenence' && $page_name != 'privacy' && $page_name != 'auth_boxed' && $page_name != 'auth_default')
    ...
    <!--  UPLOAD MODAL  -->
    <div class="modal fade" id="uploadModal" tabindex="-1" role="dialog" aria-labelledby="clienteditModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header bg-info text-center">
                    <h5 class="modal-title text-white" id="uploadModalTitle"></h5>
                ...
                <div class="modal-body pl-4 pr-4">
                    <div id="init_content" style="max-height:455px;overflow-y:auto">
                    <form id="uploadForm" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <h6 class="mb-3">Suivez les étapes ci-dessous ...</h6>
                        <div class="mb-4 border-bottom pb-3">
                            ...
                            <a href="" class="text-primary" id="btn_download_model"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-upload"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="17 8 12 3 7 8"></polyline><line x1="12" y1="3" x2="12" y2="15"></line></svg> Télécharger le modèle</a>
                        </div>
                            <div class="mb-4 border-bottom pb-3">
                            <h6 class="text-bold">Etape 2 : Copiez vos <span class="dataUpload"></span> dans le modèle</h6>
                            <p class="mt-3">
                        ...
                        <div class="mb-4">
                            <h6 class="text-bold">Etape 3 : Chargez le modèle contenant vos <span class="dataUpload"></span></h6> 
                            <span class="text-color-linna1 text-bold">Vous pouvez importer un maximum de 1000 lignes à la fois !</span> (formats attendus : xlsx, xls, csv)
                            <p class="mt-3">
                                <div class="custom-file-container" data-upload-id="myFirstImage">
                                        <label class="custom-file-container__custom-file" >
                                        <input type="file" class="custom-file-container__custom-file__custom-file-input border" accept=".csv, .xls, .xlsx" id="file" name="file" dataType="" targetURL="">
    ...
    <div id="progressbarToast"></div>

    <!--  BEGIN FOOTER  -->
    <div class="footer-wrapper">
        <div class="footer-section f-section-1">
            <p class="">Copyright © 2020 <a target="_blank" href="{{ config('app.website') }}"><span class="text-color-linna1">{{ config('app.name') }} sarl</span></a>, Tous droits réservés.</p>
        </div>
    </div>
    <!--  END FOOTER  -->
